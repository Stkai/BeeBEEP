...
public:
  ...
  enum Type { Undefined, Beep, Hello, Ping, Pong, Chat, System, User, File, Share, Group, Folder, Read, Hive, ShareBox, DesktopShare, NumTypes };
  enum Flag { Private, UserWriting, UserStatus, UserName, UserVCard, Refused, List, Request, GroupChat, NumFlags };
