...
public:
  ...
  enum Flag { Private, UserWriting, UserStatus, Create /* it was UserName in 3.0.9 */, UserVCard, Refused, List, Request, GroupChat, Delete, Auto, Important, VoiceMessage, NumFlags };
