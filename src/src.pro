...
win32: DEFINES += BEEBEEP_USE_MULTICAST_DNS
win32: HEADERS += MDnsBrowser.h MDnsManager.h MDnsObject.h MDnsRecord.h MDnsRegister.h MDnsResolver.h
win32: SOURCES += MDnsBrowser.cpp MDnsManager.cpp MDnsObject.cpp MDnsRecord.cpp MDnsRegister.cpp MDnsResolver.cpp
