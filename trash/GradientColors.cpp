...
//
// $Id: RainbowTextMarker.cpp 98 2011-09-14 17:47:42Z mastroddi $
//
//////////////////////////////////////////////////////////////////////
...
namespace
{
  ...
  QColor GetRainbowColor( qreal k, bool inverse )
  {
    int r = static_cast<int>( 127 + 127 * qCos( k - .5 ) );
    int g = static_cast<int>( 127 + 127 * qCos( k - 2.5 ) );
    int b = static_cast<int>( 127 + 127 * qCos( k - 4.5 ) );
  ...
  if( index >= 0 && txt.size() > index )
  {
    ...
    if( last_index > 0 )
    {
      ...
      for( int i = 0; i < txt.size(); i++ )
      {
        ...
        {
          QString str_to_append = QString( "<font color=""%1"">" ).arg( GetRainbowColor( k, false ) );
          if( code_text.size() > 0 )
          {
