...
OutputBaseFilename=beebeep-setup-5.4.2
...
[Files]
Source: "..\..\beebeep-5.4.2\beebeep.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\beebeep-5.4.2\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
