...
OutputBaseFilename=beebeep-setup-5.2.0
...
[Files]
Source: "..\..\beebeep-5.2.0\beebeep.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\beebeep-5.2.0\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
