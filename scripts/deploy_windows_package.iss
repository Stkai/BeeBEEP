...
OutputBaseFilename=beebeep-setup-5.0.0
...
[Files]
Source: "E:\SOURCES\beebeep-5.0.0\beebeep.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "E:\SOURCES\beebeep-5.0.0\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
