...
OutputBaseFilename=beebeep-setup-5.0.1
...
[Files]
Source: "E:\SOURCES\beebeep-5.0.1\beebeep.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "E:\SOURCES\beebeep-5.0.1\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
