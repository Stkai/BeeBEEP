...
OutputBaseFilename=beebeep-setup-4.2.0
...
[Files]
Source: "E:\SOURCES\beebeep-4.2.0\beebeep.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "E:\SOURCES\beebeep-4.2.0\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
