...
OutputBaseFilename=beebeep-setup-5.4.0
...
[Files]
Source: "..\..\beebeep-5.4.0\beebeep.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\beebeep-5.4.0\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
