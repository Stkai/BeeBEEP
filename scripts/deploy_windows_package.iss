...
OutputBaseFilename=beebeep-setup-3.2.0
...
[Files]
Source: "E:\SOURCES\beebeep-3.2.0-install\beebeep.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "E:\SOURCES\beebeep-3.2.0-install\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
