...
OutputBaseFilename=beebeep-setup-5.6.8
...
[Files]
Source: "..\..\beebeep-5.6.8\beebeep.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\beebeep-5.6.8\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
