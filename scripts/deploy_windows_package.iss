...
OutputBaseFilename=beebeep-setup-5.4.3
...
[Files]
Source: "..\..\beebeep-5.4.3\beebeep.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\beebeep-5.4.3\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
