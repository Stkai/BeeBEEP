...
OutputBaseFilename=beebeep-setup-3.0.8
...
[Files]
Source: "E:\SOURCES\beebeep-3.0.8-mise\beebeep.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "E:\SOURCES\beebeep-3.0.8-mise\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
