...
[Files]
Source: "E:\SOURCES\beebeep-3.2.0-mise\beebeep.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "E:\SOURCES\beebeep-3.2.0-mise\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
