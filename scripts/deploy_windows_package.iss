...
OutputBaseFilename=beebeep-setup-5.4.1
...
[Files]
Source: "..\..\beebeep-5.4.1\beebeep.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\beebeep-5.4.1\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
