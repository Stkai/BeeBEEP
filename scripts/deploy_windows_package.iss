...
OutputBaseFilename=beebeep-setup-5.6.2
...
[Files]
Source: "..\..\beebeep-5.6.2\beebeep.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\beebeep-5.6.2\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
